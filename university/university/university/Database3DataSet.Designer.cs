...
namespace university {
    ...
    public partial class Database3DataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public studentRow AddstudentRow(string username, string password) {
...
namespace university.Database3DataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[student] WHERE (([username] = @Original_username) AND ([passwo" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([username], [password]) VALUES (@username, @password" +
                ");\r\nSELECT username, password FROM student WHERE (username = @username)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[student] SET [username] = @username, [password] = @password WHERE (" +
                "([username] = @Original_username) AND ([password] = @Original_password));\r\nSELEC" +
                "T username, password FROM student WHERE (username = @username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::university.Properties.Settings.Default.Database3ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password FROM dbo.student";
        ...
        public virtual int Fill(Database3DataSet.studentDataTable dataTable) {
        ...
        public virtual Database3DataSet.studentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database3DataSet.studentDataTable dataTable = new Database3DataSet.studentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database3DataSet.studentDataTable dataTable) {
